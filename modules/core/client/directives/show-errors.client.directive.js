    ...
    function compile(elem, attrs) {
      ...
      function linkFn(scope, el, attrs, formCtrl) {
        ...
        function checkValidity(event, name) {
          // || formCtrl[inputName].$name== name allows broadcasted tag to be customized by form error type
          if (angular.isUndefined(name) || formCtrl.$name === name || formCtrl[inputName].$name== name) {
