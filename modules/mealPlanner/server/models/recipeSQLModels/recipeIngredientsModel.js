...
var RecipeIngredientsModel = sequelize.define('recipeIngredientsModel', {
  title: { type: Sequelize.STRING, allowNull: false}, //set as primary key
  quantity: {type: Sequelize.FLOAT, allowNull: true},
  measurement: {type: Sequelize.STRING, allowNull: true},
  // measurementAbbr: {type: Sequelize.STRING, allowNull: true},
  ingredient: {type: Sequelize.STRING, allowNull: true},
  fullIngredient: {type: Sequelize.STRING, allowNull: false},
  ...
  vitamineAIU: {type: Sequelize.FLOAT, allowNull: true}, //a measured in iu
  ...
  // temporarily store recipe nutrition here after calculation?
  // tags
  //add in measurement abbrv?
});
